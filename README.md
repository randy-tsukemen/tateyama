...
- 雷鳥莊：日曆全部五種房型，包含「個室（非單人）」與「個室1名利用」，各自獨立判斷。
  一般個室只要有空房便通知，不受單人個室是否額滿影響；人數與價格需在訂房頁確認。
- みくりが池温泉：1 位成人，男女共用 6 人相部屋、8 人上下舖相部屋、官網限定 4 人相部屋。
...
另設定 `TELEGRAM_GROUP_ID` 時，訊息會同時傳送至私人對話及指定群組。
任一接收對象失敗仍會嘗試另一個，最後將未確認送達的情況回報為失敗。
群組設定要求指定群名與 Bot 指令，且指令須由目前私人通知的使用者傳送。
